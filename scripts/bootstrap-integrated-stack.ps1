...
Write-Output "Identity preflight passed: main-site discovery/JWKS and Open WebUI OIDC provider are available"
Write-Output "Identity callbacks are not verified by this script; run the main-site HTTP contract and downstream login acceptance"
